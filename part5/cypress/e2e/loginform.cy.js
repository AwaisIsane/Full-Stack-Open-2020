describe('Blog App', function() {
  ...
  describe('Login test',function() {
    it('succeeds with correct credentials',function() {
      ...
      cy.contains('youre logged in as mluukkai')
    })
  ...
  describe('when logged in',function() {
    ...
    it('A blog can be created', function() {
      ...
      cy.contains('adding a blog with cypress test')
    })
    ...
    describe('after a single blog is created', function() {
      ...
      it('users who created a blog can delete it',function() {
        ...
        cy.contains('adding a block with cypress before test test1').should('not.exist')
      });
